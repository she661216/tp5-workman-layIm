<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpIm\laychat-master\public/../application/index\view\index\index.html";i:1516100006;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
layui.use('layim', function(layim){
	...
	layim.config({
		...
		//获取群员接口
		,members: {
		  url: "<?php echo url('index/getMembers'); ?>" //接口地址（返回的数据格式见下文）
		  ,type: 'get' //默认get，一般可不填
		  ,data: {} //额外参数
		},
		uploadFile: {
	...
	socket.onopen = function(){
		// 登录
        var login_data = '{"type":"init","id":"<?php echo $uinfo['id']; ?>","username":"<?php echo $uinfo['username']; ?>","avatar":"<?php echo $uinfo['avatar']; ?>","sign":"<?php echo $uinfo['sign']; ?>"}';
